...
```
$ docker run -p 3000:3000 --rm "$(docker build -q -f Dockerfile . --build-arg BUNDLER_VERSION_TO_INSTALL=2.0.2)"
...
```
$ docker run -p 3000:3000 --rm "$(docker build -q -f Dockerfile . --build-arg BUNDLER_VERSION_TO_INSTALL=2.1.0)"
